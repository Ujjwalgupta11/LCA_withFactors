...
levels(test$CASE_SUBMITTED_MONTH) = c("1", "10", "11", "12", "2", "3", "4", "5", "6", "7", "8", "9")
test$CASE_SUBMITTED_YEAR = as.factor(as.character(test$CASE_SUBMITTED_YEAR))
levels(test$CASE_SUBMITTED_YEAR) = c("2011", "2012", "2013", "2014", "2015", "2016", "2017")
test$DECISION_MONTH = as.factor(as.character(test$DECISION_MONTH))
levels(test$DECISION_MONTH) = c("1", "10", "11", "12", "2", "3", "4", "5", "6")
test$DECISION_YEAR = as.factor(as.character(test$DECISION_YEAR))
levels(test$DECISION_YEAR) = c("2016", "2017")
